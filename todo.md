...
- When clicking apost in the map, it should show its influence area.
...
Groups have "Name" 
Users can manage their groups from a new  page called "My Groups" on thye sidebar/
...
- We will also create the concept of "Groups". Here, two or more members can share "Folders", "Calendars", ands "Tasks" with equal access.
